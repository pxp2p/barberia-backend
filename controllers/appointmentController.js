...
const webpush = require('web-push'); // <-- ¡VITAL! Evita que se cuelgue el servidor al enviar notificaciones
...
// 3. RESERVAR EL TURNO (¡EL ENLACE RECUPERADO CON MÓDULO PUSH AL BARBERO!)
